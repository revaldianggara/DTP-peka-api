...
angular.module("layerControl").controller("webgisCtrl", ["$scope", "$http", "$mdSidenav", "$timeout", "mapService_webgis", "$mdDialog", "$mdToast", "$interval", webgisCtrl]);

function webgisCtrl($scope, $http, $mdSidenav, $timeout, mapService_webgis, $mdDialog, $mdToast, $interval) {
