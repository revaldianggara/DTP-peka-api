(function () {
        ...
        function dataInputZpCtrl($scope, $http, $mdDialog, $timeout) {
                ...
                $scope.loadKabupaten = function () {
                        $http({
                                method: "GET",
                                url: "/mgmt/input/ZonaPotensi/getLocId",
                        }).then(
                ...
                $scope.loadInput = function () {
                        $http({
                                method: "GET",
                                url: "/mgmt/input/ZonaPotensi/getFeatureType",
                        }).then(
                                function querySuccess(response) {
                ...
                $scope.loadDetail = function (itm, itm2, cond) {
                        ...
                        $http({
                                method: "GET",
                                url: "/mgmt/input/ZonaPotensi/getFeatureDetail",
                                params: {
                                        inpid: sltid,
                                        locid: selkab,
                                        ofs: paglog,
                ...
                $scope.downloadTemplate = function () {
                        ...
                        $http({
                                method: "GET",
                                url: "/mgmt/input/ZonaPotensi/getDownloadTemp",
                        }).then(
                                function querySuccess(response) {
                ...
                $scope.deleteFeature = function (ev, iditm) {
                        ...
                        $mdDialog.show(confirm).then(
                                function () {
                                        $http({
                                                method: "GET",
                                                url: "/mgmt/input/getDeleteFeature",
                                                params: {
                                                        idf: iditm.id,
                                                },
                                        }).then(
