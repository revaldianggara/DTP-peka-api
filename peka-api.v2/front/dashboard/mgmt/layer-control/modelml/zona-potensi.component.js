...
function modelmlZpCtrl($scope, $http, $mdDialog, $interval) {
    ...
    $scope.loadModDetail = function (itm) {
        ...
        $http({
            method: "GET",
            url: "/mgmt/model_zp/getStreamLog",
            params: {
                modid: itm.id
            }
        }).then(function querySuccess(response) {
    ...
    $scope.pauseModel = function (mid) {
        $http({
            method: "GET",
            url: "/mgmt/model_zp/getPausePred",
            params: {
                idm: mid
            }
        }).then(function querySuccess(response) {
    ...
    $scope.cancelModel = function (ev, mid) {
        ...
        $mdDialog.show(confirm).then(function () {
            $http({
                method: "GET",
                url: "/mgmt/model_zp/getCancelModel",
                params: {
                    idm: mid
                }
            }).then(function querySuccess(response) {
    ...
    $scope.deleteModel = function (ev, mid) {
        ...
        $mdDialog.show(confirm).then(function () {
            $http({
                method: "GET",
                url: "/mgmt/model_zp/getDeleteModel",
                params: {
                    idm: mid
                }
            }).then(function querySuccess(response) {
