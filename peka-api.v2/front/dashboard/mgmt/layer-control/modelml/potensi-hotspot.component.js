(function () {
        ...
        function modelmlPhCtrl($scope, $http, $mdDialog, $interval) {
                ...
                $scope.loadModDetail = function (itm) {
                        ...
                        $http({
                                method: "GET",
                                url: "/mgmt/model_ph/getStreamLog",
                                params: {
                                        modid: itm.id
                                }
                        }).then(function querySuccess(response) {
                ...
                $scope.pauseModel = function (mid) {
                        $http({
                                method: "GET",
                                url: "/mgmt/model_ph/getPausePred",
                                params: {
                                        idm: mid
                                }
                        }).then(function querySuccess(response) {
                ...
                $scope.cancelModel = function (ev, mid) {
                        ...
                        $mdDialog.show(confirm).then(function () {
                                $http({
                                        method: "GET",
                                        url: "/mgmt/model_ph/getCancelModel",
                                        params: {
                                                idm: mid
                                        }
                                }).then(function querySuccess(response) {
                ...
                $scope.deleteModel = function (ev, mid) {
                        ...
                        $mdDialog.show(confirm).then(function () {
                                $http({
                                        method: "GET",
                                        url: "/mgmt/model_ph/getDeleteModel",
                                        params: {
                                                idm: mid
                                        }
                                }).then(function querySuccess(response) {
