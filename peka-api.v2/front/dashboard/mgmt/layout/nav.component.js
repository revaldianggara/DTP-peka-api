...
angular
  ...
  .controller("headerCtrl", ["$scope", "$mdDialog", headerCtrl])
...
function sidebarCtrl($scope) {
  $scope.activeMenu = "datainput-ph";
  $scope.changeActiveMenu = function (id) {
    $scope.activeMenu = id;
  };
}

function headerCtrl($scope, $mdDialog) {
...
function collapseNav() {
  ...
  function link(scope, ele, attrs) {
    ...
    $lists.append(
      '<i class="ti-angle-down icon-has-ul-h"></i><i class="ti-angle-right icon-has-ul"></i>'
    );
