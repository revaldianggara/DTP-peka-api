    ...
    .component('layerControl', {
        ...
        controller:
            function layercontrolController($scope, $http, mapService, $mdDialog) {
                ...
                var temp = {};
                $scope.detailFrame = 'http://karhutla.ai-innovation.id/dashboard/mgmt/webgis/';
                ...
                $scope.loadYearDetail = function(itm, itm2) {
                    ...
                    if (itm2.toggle) {
                        ...
                        $http({
                            method : "GET",
                            url : "/mgmt/input/getFeaturePeriod",
